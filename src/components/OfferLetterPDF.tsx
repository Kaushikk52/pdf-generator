  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.text}>The formal letter of Appointment will be issued immediately after you join the Company.</Text>
          <View style={styles.bulletPoint}>
            <Text style={styles.bullet}>•</Text>
            <Text style={styles.bulletContent}>KYC Documents – Copy of Aadhaar card, PAN card, Passport size photograph</Text>
          </View>
          <View style={styles.bulletPoint}>
            <Text style={styles.bullet}>•</Text>
            <Text style={styles.bulletContent}>Educational documents – Copy of 10th , 12th & Graduation Mark sheet</Text>
          </View>
          <View style={styles.bulletPoint}>
            <Text style={styles.bullet}>•</Text>
            <Text style={styles.bulletContent}>Experience documents – Copy of Experience proof</Text>
          </View>
          <View style={styles.bulletPoint}>
            <Text style={styles.bullet}>•</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.text}>
            You shall be informed that your shift timing is 9:30-7.00 pm. The office hours are subject to
            change at the management's discretion; hence every employee should adhere to their timing
            attendance. We attach consideration significance to the strict adherence of these timings and to
            regular attendance.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            The employee should not disclose his salary to anyone apart from the concerned HR of the
            organization or leak out any confidential data of the company or tamper the company's property
            where about should not be found on personal calls through the company's cellular device, if
            found guilty the deduction of the bill would be taken out from the salary along with the necessity
            actions by the management.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            You shall use the Company name, Logos, trademarks or other identifiers strictly in the manner
            permitted by the Company's policies or for the purposes of provision of Services delegated to
            you to the extent required.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>Attendance Criteria- 90 minute Talk time or 4 meeting in a Day or else 1 sales of a Day.</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            You shall be on probation for a period of six months from the date of joining service of the
            Company after completion at six months and in the absence of any letter of confirmation from
            the Management, it is understood that your Probation period has been extended until such time
            as you get a letter of confirmation. During probation you will not be entitled to any form of paid
            leave which is otherwise available to confirmed employees as per the rules of the Company.
            Thereafter, subject to your good performance your services would be confirmed.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            You will get fixed week off. (Sunday/Market specific) incase if you take any leave on Saturday as
            well as Monday you Sunday will be counted as lost of pay & the company won't be liable for that.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
...
for 2 days if this is done multiply time we will be taking strict action against you.
        ...
        <View style={styles.section}>
          <Text style={styles.text}>
            In case of non-reporting for 3 days, the company holds the right to revoke the offer of
            employment with no further dues. You will be consider absconded and the company will be
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          <Text style={styles.text}>
            When you want to leave the company then you need to serve 60 days of notice period. If you
            want to leave the company on immediate basis then there will be 30 days of deduction from your
            salary.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            Salary cycle is 1st – 30th of every month which shall be paid before 15th of succeeding Month.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            The office hours are subject to change at the management's discretion hence every employee
            should adhere to their timing attendance. We attach consideration significance to the strict
            adherence of these timings and to regular attendance.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            Though you have been engaged for a specific position, the company reserves the right to
            determine the type of range of work you may be subsequently called upon to perform as also the
            place where you may be posted. Your services can also be transferred to any concerned within
            the group/associate companies.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            Apart from your usual duties, your scope of work will extend over any kind of work as may be
            required by circumstances and the Management's decision in this regard will be final.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.text}>
            You shall abide by the rules and regulations of the company as amended from time to time is
            letter and spirit. Any non-compliance of the same shall render you liable for action by the
            management including termination of employment.

            The management reserves the right to determine compensation changes from year to year
            depending on your performance during the year under review.

            You are not entitled to be employed with any other employer or be interested directly or
            indirectly in other business, as a freelancer, vocation or calling during your employment with the
            Company. Such disclosure will lead to direct termination of your appointment without pay.

            Any information that you obtain from time to time regarding the Company's process methods
            practices etc. should be treated as being utmost confidential and proprietary in character and will
            not divulge the same to any one not in employment with the Company. Any such act will be
            considered seriously detrimental to the interest of the company and be dealt with appropriately.

            Your work in the organization will be subject to the rules and regulations of the organization as
            laid down in relation to conduct, discipline and other matters. You will always be alive to
            ...
            of interest, and potential consequences.

            I accepted the above terms & Guidelines. If I am not following the above rules, then company
            will take an action and I have no objection in this regards.
          </Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.subtitle}>Candidate's Name: ...........................................................................</Text>
          <Text style={styles.subtitle}>Candidate's Email: ...........................................................................</Text>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.subtitle}>Date of Joining: ...........................................................................</Text>
          <Text style={styles.subtitle}>Employee ID: .............................................................................</Text>
          <Text style={styles.subtitle}>Department: ...............................................................................</Text>
          <Text style={styles.subtitle}>Reporting Manager: .....................................................................</Text>
        </View>
        <View style={styles.footer}>
